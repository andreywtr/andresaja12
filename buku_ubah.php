        ...
        <div class="row">
            <div class="col-md-12">
                ...
                if(isset($_POST['submit'])) {
                    ...
                    $query = mysqli_query($koneksi, "UPDATE buku set id_kategori='$id_kategori', judul='$judul', 
                    penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit' WHERE buku_id=$id");
                    if($query) {
